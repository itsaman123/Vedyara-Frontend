      ...
      <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12 py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          >
            ...
            {/* Marketplace badges — Meesho first (priority) */}
            <div className="flex flex-wrap gap-3">
              <a
                ...
                style={{
                  background: "rgba(163,0,137,0.12)",
                  border: "1px solid rgba(163,0,137,0.3)",
                }}
              >
                <span style={{ fontSize: "1.1rem" }}>🛍️</span>
                <div>
                  <p style={{ fontSize: "0.62rem", color: "rgba(248,245,240,0.45)", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.1em" }}>Shop on</p>
                  <p style={{ fontSize: "0.82rem", color: "#e838cd", fontWeight: 700, letterSpacing: "0.02em" }}>Meesho</p>
                </div>
                <FiExternalLink size={13} style={{ color: "rgba(232,56,205,0.6)", marginLeft: "auto" }} />
              </a>
              <a
